...
object SparkSQLDemo7 {
  def main(args: Array[String]): Unit = {
    ...
    spark.sql("CREATE TEMPORARY FUNCTION MySplit1 as 'com.kkb.sparksql.demo.MySplit'")

    spark.sql("select part_place,MySplit1(part_place,' ') from house_sale limit 50").show()
    spark.stop()
  }
}
